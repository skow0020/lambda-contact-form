(function ($) {
  ...
  let submitButton = $(".validate-form .contact3-form-btn");
  ...
  $(".validate-form").submit((event) => {
    ...
    $.post(
      "https://hf8r5n5mz8.execute-api.us-east-1.amazonaws.com/default/ContactFormFunction",
      { name, email, message }
    )
      .done((_) => {
        showMessage(
      ...
      .fail((_) => {
        showMessage(
          "Something went wrong when submiting the message",
          "danger"
        );
